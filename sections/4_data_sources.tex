...
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{3cm}>{\raggedright\arraybackslash}p{5.5cm}>{\raggedright\arraybackslash}p{5cm}@{}}
\toprule
\textbf{Source} & \textbf{Variables Extracted} & \textbf{Model Application} \\
\midrule
\textbf{O*NET} \newline {\scriptsize (v28.3, 2024)}
  & 41 Work Activities \newline Work Context indicators \newline 35 Skill descriptors
  & Task weights $w_k$ \newline Physical Protection $P_i$ \newline Initial capability $V_{s,0}$ \\[8pt]
\textbf{BLS OEWS} \newline {\scriptsize (2010--2024)}
  & National employment levels \newline Wage percentile estimates
  & Calibration target (2010--22) \newline Consistency check (2023--24) \\[8pt]
\textbf{IPEDS} \newline {\scriptsize (2015--2023)}
  & Program completions \newline Award levels by institution
  & Educational supply $S(t)$ \newline Enrollment recommendations \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lllll}
\toprule
\textbf{Occupation} & \textbf{Metric} & \textbf{Source/Code} & \textbf{Years} & \textbf{Extraction} \\
\midrule
Info Security & Employment & BLS / SOC 15-1212 & 2012--24 & National May \\
Info Security & Completions & IPEDS / CIP 11.1003 & 2015--23 & Award level 7 \\
Electricians & Employment & BLS / SOC 47-2111 & 2010--24 & National May \\
Electricians & Completions & IPEDS / CIP 46.0302 & 2015--23 & Levels 1,2,3,21 \\
Graphic Design & Employment & BLS / SOC 27-1024 & 2010--24 & National May \\
Graphic Design & Completions & IPEDS / CIP 50.0409 & 2015--21 & Levels 5,7 \\
\bottomrule
\end{tabular}
\end{table}

\noindent\textit{Notes: SOC 15-1212 available from 2012 (SOC-2010 revision). IPEDS award levels: 1=Cert$<$1yr, 2=Cert 1--2yr, 3=Assoc, 5=Bach, 7=Master's. RISD unavailable post-2021; carried forward with uncertainty flag.}
