...
\textit{\textbf{Key Insight:} Graphic Designers show greatest sensitivity to both $A_{\text{cap}}$ and $\varepsilon_D$: a 20\% ceiling increase shifts employment from +0.2\% to $-4.5\%$; conversely, high demand elasticity ($\varepsilon_D = 0.8$) restores positive growth via Jevons effect.}
