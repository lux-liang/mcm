...
The sensitivity analysis identifies parameter boundaries beyond which the model predicts regime transitions. These are \textit{model-implied thresholds} conditional on the TECM structure, not empirically observed breakpoints:
