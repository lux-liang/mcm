...
\textit{\textbf{Key Insight:} For Graphic Designers, $V_s$ growth from 0.4 to 0.725 reduces sub\_ratio from 0.55 to $\sim$0.42, shifting $A^*$ from 90.9\% to 119\% (exceeding $A_{\text{cap}}$)---converting potential displacement to permanent augmentation.}
