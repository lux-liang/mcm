...
\end{tabular}
\end{table}
\noindent\textit{Note: ``$\times$'' denotes multiplicative factor relative to baseline. Ranges represent plausible bounds; no claim of empirical identification is made. All tested via sensitivity analysis (Sec.~9).}
